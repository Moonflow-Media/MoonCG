...
class NcgSettings extends Polymer.PolymerElement {
	static get template() {
		...
		<paper-card heading="Your Key">
			<div class="card-content">
				...
				<div class="card-actions">
					<paper-button raised="" id="copyKey" class="mooncg-benign">
						<iron-icon icon="icons:content-copy"></iron-icon>
						<span>Copy Key</span>
					</paper-button>
					<paper-button raised="" id="showKey" class="mooncg-configure" title="Show Key" on-tap="openShowKeyDialog">
						<iron-icon icon="communication:vpn-key"></iron-icon>
						<span>Show Key</span>
					</paper-button>
					<paper-button raised="" id="resetKey" class="mooncg-reject" on-tap="openResetKeyDialog">
		...
		<paper-dialog id="resetKeyDialog">
			...
			<div>
				<p class="text-warning paper-font-body1">
					Are you sure you wish to reset your <b>MoonCG key</b>?<br>
