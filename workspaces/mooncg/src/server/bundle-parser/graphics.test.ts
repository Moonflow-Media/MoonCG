...
test('when there is a "graphics" folder but no "graphics" property, throw an error', () => {
	expect(
		...
		`[Error: no-graphics-prop has a "graphics" folder, but no "mooncg.graphics" property was found in its package.json]`,
	);
});
...
test('when there is a "graphics" property but no "graphics" folder, throw an error', () => {
	expect(
		...
		`[Error: no-graphics-folder has a "mooncg.graphics" property in its package.json, but no "graphics" folder]`,
	);
});
