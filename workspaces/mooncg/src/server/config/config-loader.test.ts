...
test("should throw an error when the config file is not valid JSON", () => {
	expect(
		loadConfig.bind(
			loadConfig,
			testDirPath("fixtures/mooncg-core/cfg/invalidJSON.json"),
		),
...
test('should validate the "login" object when "login.enabled" is "true"', () => {
	expect(
		loadConfig.bind(
			loadConfig,
			testDirPath("fixtures/mooncg-core/cfg/invalidLogin.json"),
		),
...
test('should validate the "login.steam" object when "login.steam.enabled" is "true"', () => {
	expect(
		loadConfig.bind(
			loadConfig,
			testDirPath("fixtures/mooncg-core/cfg/invalidSteam.json"),
		),
...
test('should validate the "login.twitch" object when "login.twitch.enabled" is "true"', () => {
	expect(
		loadConfig.bind(
			loadConfig,
			testDirPath("fixtures/mooncg-core/cfg/invalidTwitch.json"),
		),
...
test('should validate the "login.discord" object when "login.discord.enabled" is "true"', () => {
	expect(
		loadConfig.bind(
			loadConfig,
			testDirPath("fixtures/mooncg-core/cfg/invalidDiscord.json"),
		),
...
test('should validate the "ssl" object when "ssl.enabled" is "true"', () => {
	expect(
		loadConfig.bind(
			loadConfig,
			testDirPath("fixtures/mooncg-core/cfg/invalidSSL.json"),
		),
...
test("should support YAML configs", () => {
	const result = loadConfig(testDirPath("fixtures/mooncg-core/cfg-yaml"));
	expect(result.config.host).toBe("yaml-config");
});

test("should support CommonJS configs", () => {
	const result = loadConfig(testDirPath("fixtures/mooncg-core/cfg-js"));
