...
export class Replicator {
	 ...
	 * Defaults to `mooncg/bundles/${bundleName}/schemas/${replicantName}.json`.
	 * @returns {object}
	 */
	declare<
		V,
	 ...
	 */
	applyOperations<V>(
		replicant: Replicant<V, MoonCG.Replicant.Options<V>>,
		operations: MoonCG.Replicant.Operation<V>[],
	): void {
