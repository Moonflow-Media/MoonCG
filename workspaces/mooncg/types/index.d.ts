...
import type { MoonCGAPIClient } from "../dist/dts/client/api/api.client";
...
import type { MoonCG } from "../dist/dts/types/mooncg";

type MoonCGAPIServer<
...
declare module "../dist/dts/types/mooncg" {
	/**
	 * A collection of types that describe MoonCG's APIs.
	 */
	namespace MoonCG {
		/**
		...
		/**
		 * An interface represting a MoonCG.Logger instance.
		 */
		export type LoggerInterface = LoggerStuff.LoggerInterface;
	}
}

export default MoonCG;
